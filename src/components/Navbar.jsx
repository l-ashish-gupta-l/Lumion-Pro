...
function Navbar() {
    ...
    return (
        <div div className="fixed z-[999] w-full px-12 py-6 flex justify-between bg-gray-300   duration-500 ease-[cubic-bezier(.3,.86,.36,.95)] bg-opacity-0 backdrop-filter backdrop-blur-md" id='navbar' >
