...
function Footer() {
    return (<>
        <div className='w-full  bg-[#F1F1F1] lg:flex '>
        ...
        <div className='bottomfooter hidden lg:flex justify-between items-center px-5 lg:px-12 py-5'>
            ...
            <div>
                <h1 className='font-[Neue] text-base text-gray-500 '>&copy; ochi design 2024. Legal Terms</h1>
            </div>
            <div>
                <h1 className='font-[Neue] text-base text-gray-500 '>Website by Ashish</h1>
            </div>
