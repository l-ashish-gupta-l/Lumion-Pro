...
function Cards() {
    return (
        <div className='w-full bg-zinc-100 '>
            <div className='w-full px-5 py-10 lg:px-20  lg:py-10  lg:h-fit  gap-2 lg:flex'>
                <div className='container  lg:w-1/2 mb-5'>
                    <div className='card w-full h-56 lg:h-96 relative  flex flex-col justify-center items-center rounded-xl bg-[#004D43]'>
                        <div className="logo w-20  lg:w-full flex justify-center items-center text-[#CDEA68]" >
